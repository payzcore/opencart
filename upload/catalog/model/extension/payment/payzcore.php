...
class ModelExtensionPaymentPayzcore extends Model {
    ...
    public function getMethod($address, $total) {
        ...
        // Build chain and token display
        $enabled_chains = $this->getEnabledChains();
        ...
        if (count($enabled_chains) === 1) {
            ...
            $chain_label = isset($chain_labels[$chain]) ? $chain_labels[$chain] : $chain;
     ...
     *   - chain (string):      TRC20, BEP20, ERC20, POLYGON, or ARBITRUM.
    ...
    public function addPayment($order_id, $payment_data) {
        $this->db->query(
            ...
            `chain` = '" . $this->db->escape($payment_data['chain']) . "',
